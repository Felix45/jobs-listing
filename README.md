...
> Built with PHP, Laravel, JavaScript and Tailwind CSS
...
```sh
  cd my-folder
  git git@github.com:Felix45/jobs-listing.git
```
...
- LinkedIn: [LinkedIn](https://linkedin.com/in/felix-ouma)
...
> I intend to add the following features in future
- Resume writing
